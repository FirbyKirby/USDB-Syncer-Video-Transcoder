...
class TranscoderSettingsDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        self.audio_normalization_enabled.setToolTip(
            ...
            "• <b>R128 (loudnorm):</b> When verification is off, files matching target format are assumed normalized and skipped.<br/>"
            "• <b>ReplayGain:</b> When verification is off, files with existing tags are skipped; missing tags trigger processing.<br/>"
            "<br/>"
        ...
        self.verification_enabled.setToolTip(
            ...
            "Check if audio is already normalized correctly before applying normalization.<br/>"
            "This verification runs even when a codec/container transcode is still required.<br/>"
            "If audio is within tolerance, normalization is skipped (and transcoding may still occur if needed).<br/>"
            "<br/>"
            ...
            "<br/>"
            "<b>How it works:</b> Verifies loudness (or ReplayGain state) against your current targets.<br/>"
            "<b>When enabled:</b> Within-tolerance files skip normalization; out-of-tolerance files are normalized.<br/>"
            "<b>When disabled:</b> Normalization decisions rely on smart-skipping and force settings."
        )
